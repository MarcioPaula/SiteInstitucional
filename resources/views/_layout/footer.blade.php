...
<footer class="page-footer white">
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                <h5 class="black-text">Vortex Sites</h5>
    ...
    <div class="center black-text">"Bem irá ao homem que se compadece e empresta; disporá as suas coisas com juízo - Salmo 112:5"</div>
    <div class="footer-copyright black-text">
        <div class="container center">

            © 2022 Vortex | by #VortexSites

        </div>
        <a href="#" id="topoSeta"><i class="fas fa-angle-up fa-2x"></i></a>
    </div>
</footer>
